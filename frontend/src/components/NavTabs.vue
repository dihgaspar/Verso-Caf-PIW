...
export default defineComponent({
  ...
  setup(props) {
    ...
    const tabs = computed(() => {
      if (props.section === "Cardapio") {
        selectedTab.value = "Cerveja";
        return ["Cerveja", "Pastel", "Hambúrguer", "Pizza", "Sucos"];
      } else if (props.section === "Biblioteca") {
        selectedTab.value = "Romance";
        return ["Romance", "Ficção", "Drama", "Comédia", "Terror"];
      }
      return [];
    });
